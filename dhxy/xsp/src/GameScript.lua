...
function gameScript.run(width, height, results)
	...
	for i,v in pairs(choicesTab1) do
		...
		if(width == 1080 and height == 1920) then
			if(v == "0") then--北倶挂机
				...
				elseif(beiJuSetting == "1") then--5点带天
					beiJu_funtab1080_1920.loopFun(width, height, "1");
				elseif(beiJuSetting == "2") then --5点捉鬼
					beiJu_funtab1080_1920.loopFun(width, height, "2");
				end
			end
			if(v == "1") then--抓鬼
			...
			if(v == "3") then --签到
				qiandao_funtab1080_1920.qiandao(width, height);
			end
		end
	end
	--第二组
	for i, v in pairs(choicesTab2) do
		...
		if(width == 1080 and height == 1920) then
			...
			if(v == "1") then --算卦
				suangua_funtab1080_1920.suangua(width, height);
			end
			if(v == "2") then --大理寺答题
				dalisi_funtab1080_1920.dalisi(width, height);
			end
		end
	end
	--第三组
	for i, v in pairs(choicesTab3) do
		...
		if(width == 1080 and height == 1920) then
			if(v == "0") then --竞技场
				jingji_funtab1080_1920.jingji(10,width, height);
			end
			if(v == "1") then --帮派
				bangpai_funtab1080_1920.bangpai(width, height);
			end
			if(v == "2") then --师门
				shimen_funtab1080_1920.shimen(width, height);
			end
			if(v == "3") then --宝图
				baotu_funtab1080_1920.baotu(width, height);
			end
		end
	end
	--第四组
	for i, v in pairs(choicesTab4) do
		...
		if(width == 1080 and height == 1920) then
			if(v == "0") then--五环
				if(wuHuanSetting == "0") then --单人五环
					wuhuan_funtab1080_1920.wuhuan(width, height,"single");
				elseif(wuHuanSetting == "1") then --双人五环
					wuhuan_funtab1080_1920.wuhuan(width, height,"double");
				end
			end
			if(v == "1") then --活跃领奖
				huoyue_funtab1080_1920.huoyue(width, height);
			end
			if(v == "2") then --200环
